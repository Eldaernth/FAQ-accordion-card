...
export default function App() {
  return (
    <div>
      ...
      plan. What is the maximum file upload size? No morse than 2GB. All files
      in your account must fit your allotted storage space. How do I reset my
      ...
      <div className="attribution">
        ...
        . Coded by{' '}
        <a href="https://dreamjo.bs/en/user/joo-norbert-60943/profile">
          Joó Norbert
        </a>
        .
      </div>
